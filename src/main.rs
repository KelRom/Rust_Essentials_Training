...
fn main() {
    ...
    let parking_lot: [[i32; 3]; 2] = [[1, 2, 3], [4, 5, 6]]; // to specific the array list the inner array first, with datatypes and how much it can hold and after specific in the outer array how many arrays you will hold.
    ...
    */
    ...
    println!(
        ...
        mem::size_of_val(&*boxed_vehicle)
    ); // deference operator just like c++ nothing new here
    ...
    let vehicle: Shuttle2 = Shuttle2 { name: "Endeavour" };
    ...
    let result: &str = match my_number {
        ...
        3 => "three",
        _ => {
            // this is a catch all/wildcard/default pattern match. use curly braces to execute multiple operations. always use wildcard at the end
...
impl Description for SpaceStation {
    fn describe(&self) -> String {
        format!(
            "The {} flying {} miles high with {} crew members",
...
// Enums ----------------------------------------------------------------------------------------------------------------------------------------
// Can hold other enums, structs, or just about any data type. I really like this. Much more powerful than c++ enums
#[derive(Debug)]
enum Shape {
    Circle(f64),
    Rectangle(f64, f64),
